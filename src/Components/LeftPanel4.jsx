...
function LeftPanel2() {
  ...
  useEffect(() => {
    ...
    if (currentUrl === "/studio") {
      selected = "Dashboard";
    } else if (currentUrl === "/dashboard/user") {
      selected = "Customization";
    } else if (currentUrl === "/dashboard/add-ads") {
      selected = "Content";
    } else if (currentUrl === "/dashboard/requests") {
      selected = "Comments";
    }
        ...
        <div className="second-panel">
          ...
          <div
            ...
            onClick={() => {
              ...
              window.location.href = "/dashboard/add-ads";
            }}
          >
      ...
      >
        ...
        <div className="second-panel">
          ...
          <div
            ...
            onClick={() => {
              localStorage.setItem("Studio-Section", "Content");
              window.location.href = "/dashbaord/add-ads";
            }}
          >
            <Tooltip
              TransitionComponent={Zoom}
