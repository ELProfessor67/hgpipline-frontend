    ...
    if (videoName === "" || videoDescription === "" || videoTags === "") {
      ...
      try {
        ...
        if (Data.success) {
          setIsPublished(true);
          setLoading(false);
          setIsLiveClicked(false);
          setStreamKey(Data.streamKey)
          setStreamUrl(Data.RTMP_URL)
          setStreanBoxOpen(true)
          // window.location.reload();
        } else {
          setLoading(true);
          setIsClicked(true);
    ...
    <>
      ...
      <div className={theme ? "studio" : "studio studio-light"}>
        ...
        <div
          className={
            theme
              ? "upload-content go-live"
              : "upload-content go-live light-mode text-light-mode"
          }
          onDrop={handleDrop}
          onDragOver={(e) => e.preventDefault()}
          style={
            isChannel === true && isLiveClicked === true
              ? { display: "flex" }
              : { display: "none" }
          }
        >
          ...
          >
            ...
            <div className="right-video-section" style={{ paddingRight: "1rem" }}>
        ...
        <div
          ...
          style={
            isChannel === true && streamBoxOpen === true
              ? { display: "flex", height: "35rem" }
              : { display: "none" }
          }
        >
          <div className="top-head">
          ...
          <div
            className="uploading-video-data"
            style={{ display: "flex",padding: "2rem",flexDirection: "column",gap: "3rem" }}

          >

            <div className="basic-channelurl-section" style={{width: "100%"}}>
              <p
                className={
                  theme
              ...
              <div className="channellink-copy">
                <input
                  ...
                  value={streamurl}
                  onClick={() => handleCopyLink(streamurl)}
                />
            ...
            <div className="basic-channelurl-section" style={{width: "100%"}}>
              ...
              >
                Note: Don't share your stream key.
              </p>
              <div className="channellink-copy">
                <input
                  type="text"
                  ...
                  value={streamkey}
                  onClick={() => handleCopyLink(streamkey)}
                />
                <ContentCopyOutlinedIcon
                  className={theme ? "coppy-id" : "coppy-id-light"}
                  onClick={() => handleCopyLink(streamkey)}
