...
function VideoSection() {
  ...
  const [adsplay, setAdsPlay] = useState(false);
  const [showAdsSkip, setShowAdsSkip] = useState(false);
  ...
  useEffect(() => {
    ...
    // const interval = setInterval(getVideoAvailableInPlaylist, 5000);
        ...
        if (errorFatal) {
          switch (errorType) {
            ...
            case HLS.ErrorTypes.MEDIA_ERROR:
              console.log("fatal media error encountered, try to recovery")
...

{
          ...
          <p className={theme ? "vid-title" : "vid-title text-light-mode"} onClick={() => setShowAds(prev => !prev)}>
            {Title}
          </p>
